...
export const JiraDashboard = () => {
  ...
  const getPriorityIcon = (priority: string) => {
    return priority === "high" ? (
      ...
      <ArrowUp className="w-3 h-3 text-orange-500 rotate-45" />
    );
  };
  ...
  return (
    <div className="h-full bg-white">
      ...
      <div className="flex h-[calc(100vh-140px)]">
        ...
        <div className="w-96 border-r border-[#CCCCCC] p-6 flex flex-col">
          {/* Search and Filters */}
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="space-y-2">
              {jiraIssues.map((issue) => (
                <div
                  key={issue.id}
                  className={`p-3 border border-[#DEDCDC] rounded cursor-pointer hover:bg-gray-50 transition-colors ${
        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <Button style={{ backgroundColor: '#D61120' }} className="text-white hover:bg-red-700 mb-4">
