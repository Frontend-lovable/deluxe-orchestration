...
export const JiraDashboard = () => {
  return (
    <div className="p-4 sm:p-6 lg:p-8" style={{ backgroundColor: '#fff' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mt-6 lg:mt-8">
        <div className="lg:col-span-2">
          <div className="bg-card rounded-lg border border-border p-4 sm:p-6">
            <div className="mb-4">
              <h2 className="text-lg sm:text-xl font-semibold mb-2">Jira Assistant</h2>
